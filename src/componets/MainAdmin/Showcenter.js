          ...
          <div id="portfolio">
            <div className="container showtop  login-second ">
              <div className="page-title text-center">
                <h1 className="text-dark">Center</h1>
                  ...
                  <div className=" tabletrans ">
                    <div className="well">
                      ...
                      <table className="table table-hover">
                        <tr>
                          <th>
                            <label className="text-dark">Center Name</label>
                          </th>
                          <th>
                            {" "}
                            <label className="text-dark">Center Manager Name</label>
                          </th>
                          <th>
                            {" "}
                          ...
                          <th>
                            {" "}
                            <label className="text-dark">Center Contact</label>
                          </th>
                          <th>
                            {" "}
                          ...
                          {/* <th>
                            {" "}
                            <label className="text-dark">AdharNo</label>
                          </th> */}
                          {/* <th>
                            {" "}
                          ...
                          {/* <th>
                            {" "}
                            <label className="text-dark">Candidatecontact</label>
                          </th>
                          <th>
                            {" "}
                          ...
                          <th>
                            {" "}
                            <label className="text-dark">Salary/day</label>
                          </th> */}
                          <th>
                             {" "}
                        ...
                        {this.state.center.map((center) => (
                          <tr>
                            ...
                            <td className="tbld text-dark">{center.Centername}</td>
                              {/* <img
                                src={`data:image/png;base64,${center.photo}`}
                                alt=""
                                width="150px"
                                height="100px"
                              ></img> */}
                        
                            <td className="tbld text-dark">{center.CenterManagername}</td>
                            <td className="tbld text-dark">{center.address}</td>
                            <td className="tbld text-dark">{center.ccontact}</td>

                            <td className="tbld text-dark">{center.candidatename}</td>
                            {/* <td className="tbld text-dark">{center.candidateaadhar}</td> */}
                            {/* <td className="tbld text-dark">{center.category}</td> */}
                            <td className="tbld text-dark">{center.gender}</td>
                            {/* <td className="tbld text-dark">{center.candidatename}</td>
                            <td className="tbld text-dark">{center.candidatename}</td> */}
                            ...
                            <td className="d-flex justify-content-center tbld">
                              <div className="btn-group ">
                                <a
                                  ...
                                  value={center._id}
                                  onClick={(e) => this.onDeleteUser(center._id, e)}
                                >
