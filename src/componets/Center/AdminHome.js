...
<section class="counts section-bg mt-5">
        ...
        <div className="product-bottom text-center">
               ...
               <h3 className="text-dark">Center Name</h3>
               <h3 className="text-dark">Center Manager Name</h3>
               {/* <h4 className="text-dark">Fees:$1000</h4> */}
             </div>
        ...
        <h3 className="text-dark">Center Name</h3>
          ...
          >
            <div className="modal-dialog">
              ...
              <h3 className="text-dark1">Center Name: :</h3>
              ...
              <div className="product-bottom text-center">
               ...
               <h3 className="text-dark1">Subject :</h3>
           
               <h3 className="text-dark1">Institition</h3>
               <h3 className="text-dark1">Contact</h3>
               <h3 className="text-dark1">Email</h3>
               <h3 className="text-dark1">Grades/Class</h3>
